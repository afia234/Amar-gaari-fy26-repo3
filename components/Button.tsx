...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  // Updated primary to Green for Mastodon Marketplace theme
  const variants = {
    primary: "bg-green-600 text-white hover:bg-green-700 active:bg-green-800 disabled:bg-green-400",
    ...
    info: "bg-blue-600 text-white hover:bg-blue-700 active:bg-blue-800 disabled:bg-blue-400"
  };
